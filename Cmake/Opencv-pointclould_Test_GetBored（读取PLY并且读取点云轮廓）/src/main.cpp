...
int main(int argc, char** argv)
{
    ...
    if (pcl::io::loadPLYFile<pcl::PointXYZ>("realsensPic1.ply", *cloud) == -1)
    {
    ...
    pcl::io::savePLYFileASCII("realsensPic1.ply", *boundPoints);
   // pcl::io::savePLYFileASCII("C:\\Users\\fhlhc\\Desktop\\NoBoundpoints.ply", noBoundPoints);
    ...
    while (!viewer->wasStopped())
    {
       ...
       // boost::this_thread::sleep(100000);//boost::posix_time::microseconds
    }
    return 0;
}
