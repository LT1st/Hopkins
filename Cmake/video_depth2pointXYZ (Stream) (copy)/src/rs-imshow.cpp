...
int main(int argc, char * argv[]) try
{
    ...
    while (!viewer2->wasStopped())
    {
        ...
        */
        ...
        cloud->is_dense = false;//True if no points are inval
 ...
 //       viewer.showCloud(cloud);//再这个窗口显示点云
        ...
        */
        ...
        seg.setDistanceThreshold (5);           //The Thereshould of segment
        ...
        if(hasbeenadded == 1)
        {
            viewer2->updatePointCloud<pcl::PointXYZ>(cloud_filtered, "sample cloud");
        //   while (!viewer.wasStopped()){}
        }
